...
Present the 30-second brief first, then offer the full report:

```
## 30-Second Brief

- **Who:** [Name], [Title] at [Company] — [authority level]
- **What they do:** [1 sentence]
- **Key signal:** [The timely trigger]
- **Your angle:** [Why your product matters to them now]
- **Watch out:** [Top risk/landmine]

Full report includes:
- Company deep dive (financials, pain signals, tech stack, news)
- Person intelligence (authority, communication style, interests)
- Product-to-prospect mapping (value connections, competitive positioning)
- Call strategy (agenda, opening line, discovery questions, value points)
- Objection prep (predicted objections with pre-loaded handles)
- Landmines to avoid
...
| 1. Gather Context + Prior Interactions | CRM (Attio/Salesforce/etc.) + outreach tool (SmartLead/etc.) + client files | None — automatic | Automatic |
| 2. Company Deep Dive | Web search (always available) | None — feeds into report | Automatic |
| 3. Person Deep Dive | Web search + LinkedIn (always available) | None — feeds into report | Automatic |
| 4. Product Mapping | None (LLM reasoning) | None — feeds into report | Automatic |
| 5. Generate Brief | None (LLM reasoning) | Review the brief | 3-5 min |

**Important:** Step 1 (Prior Interactions) should run BEFORE Steps 2-3 (web research). What you already know from your own systems is more reliable and more relevant than what you'll find on the internet. CRM notes from a previous call are worth more than a LinkedIn profile scan.

**Total time: ~5 minutes of human review** for intelligence that would take 30-60 minutes of manual research.

---

## Tips

- **Run this the night before, not 5 minutes before the call.** Give yourself time to absorb the brief and think about your approach.
- **The 30-second brief is for last-minute refreshes.** Read the full brief the night before, scan the 30-second version right before dialing.
- **Don't use everything.** The brief gives you 10+ talking points and hooks. Pick 2-3 that feel most natural. Using all of them makes you sound like a stalker, not a prepared seller.
- **The conversation hooks are your opener.** Don't start with "so tell me about your company." Start with "I saw [specific thing] — that's actually why I wanted to connect."
- **Discovery questions > value points.** Especially on first calls. Ask more than you tell. The brief arms you with questions, not a script.
- **Update the brief after the call.** Add what you learned to the notes template. This becomes CRM gold for the next call or for handoff to an AE.
- **If multiple people are on the call, request a brief for each.** The authority dynamics between attendees matter as much as individual profiles.
- **The objection prep is a safety net, not a script.** If the objection comes up, you'll be glad you prepared. If it doesn't, don't bring it up.
- **Prior interactions are your #1 advantage.** Referencing a previous email, conversation, or interaction immediately signals "I did my homework and I respect your time." The worst thing you can do is pretend a prior touchpoint didn't happen — they remember, even if you don't.
- **Check EVERY source before the call.** CRM, outreach tool, client notes, email threads, calendar history. A 2-minute check can save you from the embarrassment of saying "nice to meet you" to someone you've already emailed three times.
